                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                @foreach ($list_cart as $cart)
                                    <input type="hidden" id="hargaAwal" value="{{ $cart->produk[0]->harga_produk }}"
                                        readonly>
                                    <input type="hidden" id="hargaBaru" value="" readonly>
                                    <input type="hidden" id="jumlahAwalTest" value="{{ $cart->total }}" readonly>
                                            ...
                                            <div class="my-3">
                                                ...
                                                <div class="input-group mb-3" style="max-width: 200px;">
                                                    ...
                                                    <input type="text" class="form-control text-center border mr-0"
                                                        value="{{ $cart->total }}" id="banyak" name="total" readonly>
                            ...
                            <div class="row mb-5">
                                <table class="table">
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><strong class="text-black" id="totalJumlah">0</strong></td>
                                    </tr>
